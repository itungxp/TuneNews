...
import com.tune.news.utils.StringUtils;
...
public class DrawerAdapter extends BaseAdapter {
    ...
    private int mAllUnreadNumber, mFavoritesNumber, mNoOfCustomFeeds = 1;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mFeedsCursor != null && mFeedsCursor.moveToPosition(position - mNoOfCustomFeeds)) {
    ...
    public boolean isItemAGroup(int position) {
        return mFeedsCursor != null && mFeedsCursor.moveToPosition(position - mNoOfCustomFeeds) && mFeedsCursor.getInt(POS_IS_GROUP) == 1;
