...
import com.tune.news.adapter.DrawerAdapter;
import com.tune.news.fragment.EntriesListFragment;
import com.tune.news.fragment.FeedsFragment;
...
import com.tune.news.service.FetcherService;
import com.tune.news.service.RefreshService;
...
public class HomeActivity extends BaseActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private int mCurrentDrawerPos = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load AdMob
        AdView mAdView = (AdView) mLeftDrawer.findViewById(R.id.adView);
            ...
            .setItems(new CharSequence[]{getString(R.string.google_news_title), getString(R.string.add_custom_feed)}, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    if (which == 1) {
                        ...
                        startActivity(new Intent(HomeActivity.this, AddDefaultNewsActivity.class));
                    }
                }
            });
    builder.show();
...
//                break;
            default:
                ...
                mFeedsViewPager.setCurrentItem(position);
                break;
        }
